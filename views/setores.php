    ...
    <table>
        ...
        ?>
            ...
            <tr>
                <td><?=$linhas['setor']?></td>
                <td>
                    <a href="<?=$urlBase?>/formSetores/<?=$linhas['idSetor']?>" class="button-icon btn-editar"><i
                            class="fa-duotone fa-pen-to-square"></i></a>
                    <a href="<?=$urlBase?>/excluir/<?=$linhas['idSetor']?>/setores" class="button-icon btn-excluir"><i
